...
const initialRows = [
  createData(1, 'Tarefa 1', 'Atividade Pratica', '2023-11-10', '2023-11-25', 'Concluída', 'Recurso 1'),
  createData(2, 'Tarefa 2', 'Estudar para prova', '2023-11-30', '2023-12-15', 'Em Andamento', 'Recurso 2'),
